...
function extractDateParts(g) {
  ...
  if (g[7]) return { year: null, month: Number(g[7]), day: Number(g[8]) };
  return { year: null, month: Number(g[9]), day: Number(g[10]) };
}
